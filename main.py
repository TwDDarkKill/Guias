...
async def setup_bot():
    ...
    if GUILD_ID is None:    
        logger.error("Nenhum servidor encontrado. Certifique-se de que o bot está em pelo menos um servidor.")
        return
...
if __name__ == "__main__":
    try:
        ...
        logger.error(f"Falha ao fazer login: `{e}`. Verifique se o TOKEN está correto.")
    except Exception as e:
        logger.error(f"Ocorreu um erro ao iniciar o bot: `{e}`")
